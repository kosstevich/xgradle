...
/**
 * Guice module for Registrars bindings.
 *
 * @author Ivan Khanas <xeno@altlinux.org>
 */

public final class RegistrarsModule extends AbstractModule {

    @Override
    protected void configure() {

        bind(Registrar.class)
                .annotatedWith(Library.class)
                .to(XmvnCompatRegistrar.class);

        bind(Registrar.class)
                .annotatedWith(Bom.class)
                .to(XmvnBomCompatRegistrar.class);
    }
}
